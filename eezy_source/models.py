...
class ProcessConfig(models.Model):
    ...
    costMarginPercentage = models.FloatField(null=True, blank=True)
    defaultCurrency = models.CharField(max_length=100, null=True, blank=True)
    active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True)

class ReceiptProcessConfig(models.Model):
    receiptProcessConfigId = models.AutoField(primary_key=True)
    sellerShipperDeliveryFee = models.FloatField(null=True, blank=True)
    sellerShipperDeliveryFeeUnit = models.CharField(max_length=100, null=True, blank=True)
    handlingFee = models.FloatField(null=True, blank=True)
    handlingFeeUnit = models.CharField(max_length=100, null=True, blank=True)
    ...
    shippingMarginUnit = models.CharField(max_length=100, null=True, blank=True)
    costMarginPercentage = models.FloatField(null=True, blank=True)
    transportationFee = models.FloatField(null=True, blank=True)
    defaultCurrency = models.CharField(max_length=100, null=True, blank=True)
    active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True)
...
class Receipt(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='receipt_customer', default=None)
    receiptProcessConfig = models.ForeignKey(ReceiptProcessConfig, on_delete=models.CASCADE, related_name='receipt_process_config', default=None)
    active = models.BooleanField(default=True)
